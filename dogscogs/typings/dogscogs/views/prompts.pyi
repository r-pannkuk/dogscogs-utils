...
class NumberPromptModal(discord.ui.Modal):
    item: Incomplete
    author: Incomplete
    def __init__(self, *, author: discord.Member | discord.User, title: str, label: str, placeholder: str, custom_id: str, min: int, max: int, default: int | None = None, row: int = 0) -> None: ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool: ...
